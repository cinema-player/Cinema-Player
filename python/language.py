...
STRINGS = {
    "en": {
        ...
        "length_empty": "Length: --:--",
        "length_clip": "Length: {duration}   {container} - {video} / {audio} - {aspect}  PAR {pixel_aspect}  {colorspace}  {loudness}",
    ...
    "de": {
        ...
        "length_empty": "Länge: --:--",
        "length_clip": "Länge: {duration}   {container} - {video} / {audio} - {aspect}  PAR {pixel_aspect}  {colorspace}  {loudness}",
